<div class="bg-white  mb-8 p-8 rounded-3xl shadow-sm border border-slate-100">
    ...
    <div>
        ...
        <label for="image_couverture_secteur_expertise" class="block text-xs font-bold text-slate-400 uppercase mb-1">Image de couverture de la solution</label>
        ...
        <div class="mt-6">
            ...
            <input type="text" id="secteur_expertise_image_couverture_url" name="secteur_expertise_image_couverture_url" class="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-normal text-sm" placeholder="https://storage.googleapis.com/uxpilot-auth.appspot.com/avatars/avatar-5.jpg">
        </div>
    ...
    <div class="mt-8">
        ...
        <input type="text" id="secteur_expertise_name" name="secteur_expertise_name" class="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-bold" placeholder="Titre du secteur d'expertise">  
    </div>
    {{-- subtitle --}}
    <div class="mt-6">
        ...
        <input type="text" id="secteur_expertise_subtitle" name="secteur_expertise_subtitle" class="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-normal text-sm" placeholder="Sous-titre du secteur d'expertise"> 
    </div>
    <div class="mt-6">
        ...
        <input type="text" id="secteur_expertise_title_hero" name="secteur_expertise_title_hero" class="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-normal text-sm" placeholder="Titre de la section hero"> 
    </div>
    <div class="mt-6">
        ...
        <textarea id="secteur_expertise_resume" name="secteur_expertise_resume" class="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-normal text-sm" rows="3" placeholder="Description du secteur d'expertise"></textarea>   
    </div>  
    <div class="mt-6">
    ...
    <div class="grid grid-cols-2 gap-6 mt-6">
        ...
        <div>
            ...
            <input type="email" id="secteur_expertise_contact_email" name="secteur_expertise_contact_email" class="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-normal text-sm" placeholder="Email de contact">
        </div>
        <div>
            ...
            <input type="text" id="secteur_expertise_contact_phone" name="secteur_expertise_contact_phone" class="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-normal text-sm" placeholder="Numéro de téléphone de contact">  
        </div>
    </div>
    <div class="bg-blue-200 text-blue-700  mt-3 rounded-md px-5">
        <i class="fas fa-info-circle"></i>
    ...
    <div class="grid grid-cols-2 gap-6 mt-6">
        ...
        <div>
            ...
            <input type="text" id="secteur_expertise_cta_1_label" name="secteur_expertise_cta_1_label" class="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-normal text-sm" placeholder="Label du premier bouton d'appel à l'action (ex: En savoir plus, Contactez-nous, etc.)">   
        </div>
        ...
        <div>
            ...
            <input type="text" id="secteur_expertise_cta_1_url" name="secteur_expertise_cta_1_url" class="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-normal text-sm font-mono text-blue-500" placeholder="URL du premier bouton d'appel à l'action (ex: https://www.exemple.com/contact)">  
        </div>
        <div>
            ...
            <input type="text" id="secteur_expertise_cta_2_label" name="secteur_expertise_cta_2_label" class="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-normal text-sm" placeholder="Label du deuxième bouton d'appel à l'action (ex: En savoir plus, Contactez-nous, etc.)">   
        </div>
        {{-- CTA URL --}}
        <div>
            ...
            <input type="text" id="secteur_expertise_cta_2_url" name="secteur_expertise_cta_2_url" class="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-normal text-sm font-mono text-blue-500" placeholder="URL du deuxième bouton d'appel à l'action (ex: https://www.exemple.com/contact)">  
        </div>
        ...
        <div>
            ...
            <input type="text" id="secteur_expertise_icon" name="secteur_expertise_icon" class="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-normal text-sm font-mono text-blue-500" placeholder="ex: https://www.exemple.com/icon.png ou fa-solid fa-cog">
        </div>
    </div>
    ...
    <div class="mt-6">
        ...
        <textarea id="secteur_expertise_description" name="secteur_expertise_description" class="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-normal text-sm" rows="6" placeholder="Description détaillée de la solution"></textarea> 
    </div>
