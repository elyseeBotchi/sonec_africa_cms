...
class UpdateEspacementMenuRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'espacement' => 'filled|integer|min:0',
            'menu_id' => 'filled|exists:menus,id',
            'gras' => 'boolean',
            'italique' => 'boolean',
    ...
    {
        return [
            'espacement.filled²' => 'Le champ espacement est obligatoire.',
            ...
            'menu_id.filled' => 'Le champ menu_id est obligatoire.',
