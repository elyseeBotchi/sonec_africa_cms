...
class StoreSolutionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // 'personnalisation_sections.*.subtitle' => 'nullable|string|max:255',
            'personnalisation_sections.*.content' => 'nullable|string',
            // 'personnalisation_sections.*.image' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            // 'personnalisation_sections.*.image_url' => 'nullable|url',
            // 'personnalisation_sections.*.cta_label' => 'nullable|string|max:255',
            // 'personnalisation_sections.*.cta_url' => 'nullable|url',
            // 'personnalisation_sections.*.icon' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:2048', 
