...
class UpdateSecteurExpertiseRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'secteur_expertise_slug' => ['nullable', 'string', 'max:255', \Illuminate\Validation\Rule::unique('secteur_expertises', 'slug')->ignore($this->route('secteur_expertise'))],
            ...
            'accroche_id'=> 'nullable|exists:secteur_expertise_accroches,id',
         
            // Chiffres
            'chiffres' => 'nullable|array',
            'chiffres.*.id' => 'nullable|exists:secteur_expertise_chiffres,id',
            ...
            'partenaires.*.id' => 'nullable|exists:secteur_expertise_partenaires,id',
            ...
            'personnalisation_sections.*.id' => 'nullable|exists:secteur_expertise_sections,id',
            ...
            'seo_id' => 'nullable|exists:secteur_expertise_seos,id',
